import { WeightedStack } from "../../src/stack";

describe("WeightedStack", () => {
  describe("with weight of 1", () => {
    let stack: WeightedStack<number>;

    beforeEach(() => {
      stack = new WeightedStack<number>(10);
    });
  ...
  describe("with variable weight", () => {
    let stack: WeightedStack<{ name: string; weight: number }>;

    beforeEach(() => {
      stack = new WeightedStack<{ name: string; weight: number }>(10, "weight");
    });
